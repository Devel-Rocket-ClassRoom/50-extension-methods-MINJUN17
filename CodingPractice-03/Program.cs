...
////1
//Console.WriteLine($"'hello' 대문자로 시작? {StringExtensions.IsCapitalized("hello")}");
//Console.WriteLine($"첫글자 대문자: {StringExtensions.Capitalize("hello")}");
//Console.WriteLine($"뒤집기: {StringExtensions.Reverse("hello")}");
